...
public class BusinessIdeasActivity extends AppCompatActivity {
    private static final String TAG = "BusinessIdeasActivity";
    ...
    private void initListView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent IdeaIntent=new Intent(BusinessIdeasActivity.this,IdeaClickedActivity.class);
                IdeaIntent.putExtra("currentDataName",currentDataName);
                IdeaIntent.putExtra("link","category/Business Ideas");
    ...
    private void RetriveAlldata() {
        ...
        RootRef.child("category").child("Business Ideas").addValueEventListener(new ValueEventListener() {
            @Override
